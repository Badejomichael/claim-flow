...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex items-center">
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 py-18 md:py-28">
        {/* Left - Hero */}
        <div className="flex-1">
          ...
          >
            A futuristic, premium airdrop claim portal — cinematic UX, secure wallet connection, and realistic mock transaction flow.
          </motion.p>
